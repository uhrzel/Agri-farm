...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Inorganic Fertilizers Records</h3>
...
<script>
    $(document).ready(function() {
        $('.delete_data').click(function() {
            ...
            _conf("Are you sure to delete this Inorganic Fertilizers Details?", "delete_inorganic_fertilizers", [$(this).attr('data-id')])
        })
        $('#create_new').click(function() {
            uni_modal("<i class='fa fa-plus'></i> Add Inorganic Fertilizers", "farmer_records/manage_inorganic_fertilizers.php")
        })
        $('.view_data').click(function() {
            uni_modal("<i class='fa fa-eye'></i> Inorganic Fertilizers Details", "farmer_records/view_inorganic_fertilizers.php?id=" + $(this).attr('data-id'))
        })
        $('.edit_data').click(function() {
            uni_modal("<i class='fa fa-edit'></i> Inorganic Ferilizers Details", "farmer_records/manage_inorganic_fertilizers.php?id=" + $(this).attr('data-id'))
        })
        $('.table').dataTable({
            columnDefs: [{
                orderable: false,
        ...
        $('.archive_btn').click(function() {
            ...
            if (confirm('Are you sure you want to archive this record?')) {
                $.ajax({
                    url: 'farmer_records/archive_inorganic.php',
                    method: 'POST',
                    data: {
                        id: id
                    },
    ...
    function delete_inorganic_fertilizers($id) {
        start_loader();
        $.ajax({
            url: _base_url_ + "classes/Master.php?f=delete_inorganic_fertilizers",
            method: "POST",
            data: {
                id: $id
            },
