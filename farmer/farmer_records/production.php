            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        $qry = $conn->query("SELECT * FROM `production_harvesting` ORDER BY `date_planted` DESC");
...
<script>
    $(document).ready(function() {
        ...
        $('#create_new').click(function() {
            uni_modal("<i class='fa fa-plus'></i> Add New Category", "farmer_records/manage_production.php")
        })
        $('.view_data').click(function() {
            uni_modal("<i class='fa fa-eye'></i> Category Details", "farmer_records/view_production.php?id=" + $(this).attr('data-id'))
        })
        $('.edit_data').click(function() {
            uni_modal("<i class='fa fa-edit'></i> Update Category Details", "farmer_records/manage_production.php?id=" + $(this).attr('data-id'))
        })
        $('.table').dataTable({
            columnDefs: [{
                orderable: false,
