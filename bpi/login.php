...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="card card-primary my-2">
      <div class="card-body">
        <p class="login-box-msg">BPI - Login</p>
        <form id="login-bpi" action="" method="post">
        ...
        <div class="modal-body">
          ...
          <form id="signup-frm" action="" method="post">
            <div class="form-group">
              <label for="bpi-firstname">Bpi Firstname</label>
              <input type="text" class="form-control" id="bpi-firstname" name="firstname" placeholder="Enter your firstname">
            </div>
            <div class="form-group">
              <label for="bpi-lastname">Bpi Lastname</label>
              <input type="text" class="form-control" id="bpi-lastname" name="lastname" placeholder="Enter your lastname">
            </div>
            <div class="form-group">
              <label for="bpi-username">Bpi Username</label>
    ...
    $(document).ready(function() {
      ...
      $('#signup-frm').submit(function(e) {
        ...
        if ($('.err-msg').length > 0)
          $('.err-msg').remove();
        $.ajax({
          url: _base_url_ + "classes/Master.php?f=bpi_register",
          method: "POST",
          data: $(this).serialize(),
          dataType: "json",
          error: err => {
